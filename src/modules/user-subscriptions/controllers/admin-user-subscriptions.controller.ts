...
export class AdminUserSubscriptionsController {
    ...
    @Get()
    @ApiOperation({ summary: 'List all user subscriptions with pagination' })
    ...
    async findAll(@Query() queryDto: ListUserSubscriptionsDto) {
        return this.userSubscriptionsService.findAll(queryDto, undefined, true);
    }
    ...
    async findOne(@Param('id') id: string) {
        return this.userSubscriptionsService.findOne(id, undefined, true);
    }
}
